...
const googleAuthClientId =
  "26923651394-ofin3np9rm8j30nvek8l4r5dub4tie9c.apps.googleusercontent.com"; // Replace with your actual Google client ID
    ...
    <GoogleOAuthProvider clientId={googleAuthClientId}>
      <div>
        {!googleLoader ? (
          ...
          <div className="border text-center py-1 rounded">
            {" "}
            <Spin size="small" />
          </div>
        )}

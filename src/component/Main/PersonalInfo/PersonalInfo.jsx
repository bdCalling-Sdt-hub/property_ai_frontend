        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-4">
            <div className="w-24 h-24 border rounded-full overflow-hidden">
              ...
              <img
                src={localImage ? localImage : userImage ?  `${imageBaseUrl}/${userImage}` : userIcon } // Show local image or default image
                alt="Profile"
            ...
            <div>
              <div className="flex flex-wrap gap-2 space-x-1">
                ...
                <button onClick={handleLogOut}  className="bg-[#edaa9d] px-3 rounded text-black">
            Log Out
          </button>
              </div>
